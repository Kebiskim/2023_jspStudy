...
<body>
<%--
	request : client가 요청한 정보를 담고 있음(파라미터도 가지고 있음)
	** request의 생명주기 => response가 이루어지면 끝난다.
	request가 가지고 있는 정보들
		- client의 정보 및 서버 정보를 얻을 수 있는 메서드를 제공
		- form 태그에서 보낸 파라미터의 정보를 제공
		- 요청 헤드의 정보 제공
		
		  1) client의 정보 및 서버 정보를 얻을 수 있는 메서드들
		 ...
		 ** 4) 다른 주요 메서드
		 	 ...
		 	 ** MVC 패턴에서 중요한 포인트 : 
		 	 	...
		 	 	-- request를 이용한 데이터 호출 : request.getAttribute("이름");
 --%>
 	<h2>Request를 활용한 client 정보 및 서버 정보 보기</h2>
 	<h3>
 		<ul>
